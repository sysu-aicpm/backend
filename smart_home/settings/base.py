...
# 设备通信配置
DEVICE_SETTINGS = {
    'VIRTUAL_DEVICE_HOST': os.getenv('VIRTUAL_DEVICE_HOST', '172.18.198.206'),
    'VIRTUAL_DEVICE_PORT': int(os.getenv('VIRTUAL_DEVICE_PORT', '5000')),
    'DEVICE_CONTROLLER_HOST': os.getenv('DEVICE_CONTROLLER_HOST', '172.18.198.206'),
    'DEVICE_CONTROLLER_PORT': int(os.getenv('DEVICE_CONTROLLER_PORT', '8080')),
    'TIMEOUT': 10,
    'MAX_RETRIES': 3,
}
